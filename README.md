# 👋 Merhaba, Ben Üzeyir İsmail Bahtiyar
...
24 yaşında, teknolojiye ve öğrenmeye tutkulu bir **girişimci** ve **full-stack geliştirici**yim. Sakarya kökenli olup İstanbul'da yaşıyorum. Üniversite hayatı ile teorik kalıplara sıkışmak yerine, doğrudan iş dünyasına atılarak pratik deneyim kazanmayı tercih ettim.
...
- **WordPress Geliştirme** (Tema ve eklenti geliştirme, PHP)
...
Ich bin ein 24-jähriger **Unternehmer** und **Full-Stack-Entwickler**, der leidenschaftlich an Technologie und Lernen interessiert ist. Ursprünglich aus Sakarya, lebe ich derzeit in Istanbul. Anstatt mich in theoretischen Universitätsmustern zu verfangen, habe ich mich entschieden, praktische Erfahrungen zu sammeln, indem ich direkt in die Geschäftswelt eingetaucht bin.

### 🎯 Woran arbeite ich gerade?

- 🔥 Arbeite als Gründer und Hauptentwickler meines Startups **Yezuri**
- 💻 Entwickle skalierbare Anwendungen mit modernen Web-Technologien
- 🎨 Arbeite an 3D-Modellierungs- und Animationsprojekten
...
#### 💻 Softwareentwicklung
- **Full-Stack-Entwicklung** (Next.js, TypeScript, Astro)
- **Mobile App-Entwicklung** (iOS & Android)
- **AI & Machine Learning** Projekte
- **API-Entwicklung** und Integrationen
- **Systemprogrammierung** (Rust, Go)
- **Backend-as-a-Service** (PocketBase)
- **WordPress-Entwicklung** (Theme- und Plugin-Entwicklung, PHP)

#### 🎨 Design & Kreativität
- **Grafikdesign** (Adobe Photoshop, Illustrator, InDesign)
- **Videoproduktion** (Premiere Pro, After Effects)
- **3D-Modellierung & Animation** (Blender)
- **UI/UX-Design**

#### 📈 Geschäftsentwicklung
- **Digitales Marketing** (Google Ads, Facebook, Instagram Ads)
- **Projektmanagement** und Teamführung
- **Unternehmertum** und strategische Planung

### 🌍 Sprachen

- 🇹🇷 **Türkisch** - Muttersprache
- 🇺🇸 **Englisch** - Mittelstufe (Pre-Intermediate)
- 🇩🇪 **Deutsch** - Anfänger
- 🇸🇦 **Arabisch** - Anfänger
...
<div align="center">
  ...
  <!-- Activity Graph -->
  <img src="https://github-readme-activity-graph.vercel.app/graph?username=uzeyirrr&theme=tokyo-night&hide_border=true&custom_title=Contribution%20Graph" alt="Activity Graph" />
